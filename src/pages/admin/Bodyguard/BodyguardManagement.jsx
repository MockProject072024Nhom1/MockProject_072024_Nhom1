...
import TableBodyguard from './TableBodyguard';
import { useNavigate } from 'react-router-dom';
import { Button, Modal } from '@mui/material';

const BodyguardManagement = () => {
  ...
  return (
    <div className="flex flex-col w-auto h-fit bg-gray-100 pt-0.5 mt-20 ml-10">
      <div className="flex justify-center items-center h-12 bg-gray-100 pb-6 border-b-4 border-gray-300">
        <span className="font-bold text-3xl">Bodyguard Management</span>
      </div>
...
export default BodyguardManagement;
